...
src/GDALTiler.o: src/GlobalGeodetic.hpp src/Bounds.hpp src/TerrainTile.hpp src/GDALTiler.hpp src/GDALTiler.cpp src/TileCoordinate.hpp
	g++ -Wall -Wextra --pedantic -c -o src/GDALTiler.o src/GDALTiler.cpp

src/TileIterator.o: src/TerrainTile.hpp src/TileIterator.hpp src/GDALTiler.hpp src/TileIterator.cpp src/TileCoordinate.hpp
	g++ -Wall -Wextra --pedantic -c -o src/TileIterator.o src/TileIterator.cpp

src/TerrainTile.o: src/TerrainTile.hpp src/TerrainTile.cpp src/TileCoordinate.hpp
